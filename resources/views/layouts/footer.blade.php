    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">Any questions? Let us know in store at SPU, Dier Ali, Ghabagheb, DR 10018 or call us on 
                (+963) 99 276 2770 / (+963) 98 879 7331</p>
                <div class="p-t-27">
                    <a href="https://facebook.com" class="fs-18 cl7 hov-cl1 trans-04 m-r-16"><i class="fa fa-facebook"></i></a>
                    <a href="https://instagram.com" class="fs-18 cl7 hov-cl1 trans-04 m-r-16"><i class="fa fa-instagram"></i></a>
                    <a href="https://pinterest.com" class="fs-18 cl7 hov-cl1 trans-04 m-r-16"><i class="fa fa-pinterest-p"></i></a>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3 p-b-50">
        ...
        <div class="p-t-40">
            ...
            <p class="stext-107 cl6 txt-center">
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by Coazastore
            </p>
        </div>
    </div>
</footer> 